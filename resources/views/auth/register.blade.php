...
<head>
  ...
  <title>Registrasi - BPBD Bandung Barat</title>
          ...
          <form action="/postregister" method="POST">
            <div class="login-userset" style="width: 460px;">
              ...
              <div class="form-login">
                ...
                <div class="form-addons">
                  <input type="date" name="tgl_lahir" class="form-control" placeholder="Masukkan email">
                </div>
              </div>
              <div class="form-login">
              ...
              <div class="signinform">
                <h4>Sudah punya akun?<a href="/login" class="hover-a"> Login</a>
                </h4>
              </div>
